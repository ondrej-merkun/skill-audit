...
5. Windsurf (global rules, workspace rules, nested workspace rules, legacy `.windsurfrules`)
6. Cross-cutting AGENTS.md + `.mcp.json` sweep (catches Copilot, Cline, Zed, Amp, Factory)
