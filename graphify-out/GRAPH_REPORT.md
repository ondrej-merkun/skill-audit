...
## Corpus Check
- 176 files · ~87,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 693 nodes · 1237 edges · 26 communities detected
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 173 edges (avg confidence: 0.8)
...
- **Thin community `Community 12`** (17 nodes): `stripAnsi()`, `expectSupportedAgentHelp()`, `runCli()`, `e2e.test.ts`, `makeEnrichmentResult()`, `makeFinding()`, `makeSkill()`, `makeSummary()`, `explain.test.ts`, `strip-ansi.ts`, `makeSkill()`, `list.test.ts`, `makeDepsDevPackageResponse()`, `makeDepsDevProjectResponse()`, `makeDepsDevVersionResponse()`, `makeSkill()`, `scan-enrichment-pipeline.test.ts`
...
- **Why does `add()` connect `Community 10` to `Community 0`, `Community 9`, `Community 11`, `Community 14`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `trim()` connect `Community 6` to `Community 0`, `Community 4`, `Community 7`, `Community 9`, `Community 14`?**
