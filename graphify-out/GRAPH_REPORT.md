...
## Corpus Check
- 151 files · ~84,154 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 607 nodes · 1068 edges · 24 communities detected
...
- **Thin community `Community 11`** (16 nodes): `stripAnsi()`, `runCli()`, `e2e.test.ts`, `makeEnrichmentResult()`, `makeFinding()`, `makeSkill()`, `makeSummary()`, `explain.test.ts`, `strip-ansi.ts`, `makeSkill()`, `list.test.ts`, `makeDepsDevPackageResponse()`, `makeDepsDevProjectResponse()`, `makeDepsDevVersionResponse()`, `makeSkill()`, `scan-enrichment-pipeline.test.ts`
...
- **Why does `add()` connect `Community 10` to `Community 0`, `Community 8`, `Community 12`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `trim()` connect `Community 6` to `Community 0`, `Community 2`, `Community 7`, `Community 8`, `Community 12`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 9` to `Community 2`, `Community 4`, `Community 6`, `Community 7`?**
