...
## Corpus Check
- 172 files · ~95,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 650 nodes · 1129 edges · 23 communities detected
...
Cohesion: 0.06
Nodes (32): appendToIgnoreList(), getConfigDir(), getIgnoreListPath(), getLegacyIgnoreListPath(), loadIgnoreList(), readIgnoreListContent(), renderDetail(), renderEnrichment() (+24 more)
...
Cohesion: 0.09
Nodes (42): cacheDir(), cacheGet(), cacheKey(), cacheSet(), legacyCacheDir(), depsDevSystem(), enrichDepsDev(), fetchDependencyLookup() (+34 more)
...
Cohesion: 0.08
Nodes (11): extractSnippet(), globalPattern(), hasNestedQuantifier(), isNestedScanRoot(), isPromptBearingCommandOrAgentDir(), isSafeRegexInput(), lineCol(), runPatternWithTimeout() (+3 more)
...
- **Why does `add()` connect `Community 10` to `Community 0`, `Community 2`, `Community 6`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `trim()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 6`, `Community 8`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 9` to `Community 0`, `Community 8`, `Community 4`, `Community 7`?**
