...
## Corpus Check
- 151 files · ~88,654 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 605 nodes · 1066 edges · 23 communities detected
...
Cohesion: 0.05
Nodes (47): appendToIgnoreList(), getConfigDir(), getIgnoreListPath(), getLegacyIgnoreListPath(), loadIgnoreList(), readIgnoreListContent(), renderDetail(), renderEnrichment() (+39 more)
...
Cohesion: 0.06
Nodes (30): discoverActivePluginPayloadTree(), discoverAgentFiles(), discoverEnabledPluginCaches(), discoverMcpToml(), discoverPluginTree(), discoverSkillDirs(), discoverUntrustedProjectConfig(), makeId() (+22 more)
...
- **Why does `add()` connect `Community 10` to `Community 0`, `Community 9`, `Community 2`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `trim()` connect `Community 6` to `Community 0`, `Community 2`, `Community 5`, `Community 7`, `Community 9`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 8` to `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 11`?**
